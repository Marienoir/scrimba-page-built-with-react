...
function Header(){
    return(
        <div className = "header">
            ...
            <h1>Want to learn Tailwind CSS?</h1>
            <p>Tailwind is the fastest growing utility-first CSS framework. Let's learn it step by step.</p>
            <button>ENROLL NOW</button>
            <div>
                <img className="tailwind-logo" src="https://www.vectorlogo.zone/logos/tailwindcss/tailwindcss-icon.svg" alt="tailwind-logo" /> 
            </div>
        </div>
    )
}
